 ...
 */
const FLAG_CONFLICT_MAP: Readonly<Record<string, string>> = {
  '-w': 'workload profile',
...
interface KnobRowProps {
  ...
  // values from optional-chained index expressions (e.g. sources.tuning?.hashcat?.workloadProfile)
  readonly source?: ConfigValueSource | undefined
  readonly onReset?: (() => void) | undefined
  readonly children: React.ReactNode
}

function KnobRow({ label, htmlFor, source, onReset, children }: KnobRowProps) {
  return (
...
function WhitelistEntryRow({ pattern, isFleet, onRemove }: WhitelistEntryRowProps) {
  return (
