...
hash_hive/
├── packages/
│   ├── backend/      # @hashhive/backend  — Bun + Hono API (all three surfaces are route-as-spec via @hono/zod-openapi)
...
- **[Super-epic #166](https://github.com/EvilBit-Labs/hash_hive/issues/166)** — authoritative status of remaining work, tracked as nested GitHub issues
