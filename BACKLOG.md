...
|   2 | `MinIO_Storage_&_File_Management`               | 3 — Resource Pipeline  | Resource API depends on it. Env-driven buckets, presigned URLs, MinIO health checks. Some chunked-upload code exists from #122 but AC isn't met.                                                                                                                          |
